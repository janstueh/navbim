...
#ifndef NAVBIM_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_TO_POSE_HPP_
#define NAVBIM_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_TO_POSE_HPP_
...
public:
   ...
   */
  bool configure(
    nav2_util::LifecycleNode::WeakPtr node,
   ...
   */
  std::string getDefaultBTFilepath(nav2_util::LifecycleNode::WeakPtr node) override;
...
protected:
  ...
  // Action client for gpp_bim path planning
  rclcpp_action::Client<navbim_msgs::action::NavbimComputePathToPose>::SharedPtr gpp_bim_client_;
...
#endif  // NAVBIM_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_TO_POSE_HPP_

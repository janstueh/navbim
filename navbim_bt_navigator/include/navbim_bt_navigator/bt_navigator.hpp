...
#ifndef NAVBIM_BT_NAVIGATOR__BT_NAVIGATOR_HPP_
#define NAVBIM_BT_NAVIGATOR__BT_NAVIGATOR_HPP_
...
/**
 * @class navbim_bt_navigator::BtNavigator
...
public:
  /**
   * @brief A constructor for navbim_bt_navigator::BtNavigator class
   * @param options Additional options to control creation of the node.
   */
  explicit BtNavigator(rclcpp::NodeOptions options = rclcpp::NodeOptions());
  /**
   * @brief A destructor for navbim_bt_navigator::BtNavigator class
   */
  ~BtNavigator();
...
#endif  // NAVBIM_BT_NAVIGATOR__BT_NAVIGATOR_HPP_

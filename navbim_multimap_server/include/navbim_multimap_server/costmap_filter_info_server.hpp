...
#ifndef NAVBIM_MULTIMAP_SERVER__COSTMAP_FILTER_INFO_SERVER_HPP_
#define NAVBIM_MULTIMAP_SERVER__COSTMAP_FILTER_INFO_SERVER_HPP_
...
public:
  /**
   * @brief Constructor for the navbim_map_server::CostmapFilterInfoServer
...
#endif  // NAVBIM_MULTIMAP_SERVER__COSTMAP_FILTER_INFO_SERVER_HPP_

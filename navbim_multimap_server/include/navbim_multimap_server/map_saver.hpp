...
#ifndef NAVBIM_MULTIMAP_SERVER__MAP_SAVER_HPP_
#define NAVBIM_MULTIMAP_SERVER__MAP_SAVER_HPP_
...
/**
 * @class navbim_map_server::MapSaver
...
public:
  /**
   * @brief Constructor for the navbim_map_server::MapSaver
   * @param options Additional options to control creation of the node.
   */
  explicit MapSaver(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());

  /**
   * @brief Destructor for the navbim_map_server::MapServer
   */
  ~MapSaver();
...
#endif  // NAVBIM_MULTIMAP_SERVER__MAP_SAVER_HPP_

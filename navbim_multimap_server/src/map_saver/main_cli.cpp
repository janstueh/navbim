...
#include "navbim_multimap_server/map_mode.hpp"
#include "navbim_multimap_server/map_saver.hpp"

#include "rclcpp/rclcpp.hpp"

using namespace navbim_multimap_server;  // NOLINT
...
int main(int argc, char ** argv)
{
  ...
  int retcode;
  try {
    auto map_saver = std::make_shared<navbim_multimap_server::MapSaver>();
